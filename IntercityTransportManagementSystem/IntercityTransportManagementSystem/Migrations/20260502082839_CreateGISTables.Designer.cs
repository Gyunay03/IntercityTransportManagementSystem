...
namespace IntercityTransportManagementSystem.Migrations
{
    ...
    [Migration("20260502082839_CreateGISTables")]
    partial class CreateGISTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntercityTransportManagementSystem.Models.BusRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntercityTransportManagementSystem.Models.LiveBusPosition", b =>
                {
                    b.Property<int>("BusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntercityTransportManagementSystem.Models.Refund", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntercityTransportManagementSystem.Models.Shape", b =>
                {
                    ...
                    b.HasKey("ShapeId", "Sequence");

                    b.ToTable("Shapes");
                });

            modelBuilder.Entity("IntercityTransportManagementSystem.Models.Stop", b =>
                {
                    ...
                    b.Property<string>("StopOriginalId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IntercityTransportManagementSystem.Models.StopTime", b =>
                {
                    b.Property<int>("TripId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntercityTransportManagementSystem.Models.TransportLine", b =>
                {
                    ...
                    b.Property<int?>("BusinessRouteId")
                        .HasColumnType("int");

                    b.Property<string>("LineOriginalId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IntercityTransportManagementSystem.Models.Trip", b =>
                {
                    b.Property<int>("TripId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TripOriginalId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IntercityTransportManagementSystem.Models.LiveBusPosition", b =>
                {
                    b.HasOne("IntercityTransportManagementSystem.Models.Trip", "Trip")
                        .WithMany()
            ...
            modelBuilder.Entity("IntercityTransportManagementSystem.Models.Refund", b =>
                {
                    b.HasOne("IntercityTransportManagementSystem.Models.Payment", "Payment")
                        .WithMany()
            ...
            modelBuilder.Entity("IntercityTransportManagementSystem.Models.StopTime", b =>
                {
                    b.HasOne("IntercityTransportManagementSystem.Models.Stop", "Stop")
                        .WithMany()
            ...
            modelBuilder.Entity("IntercityTransportManagementSystem.Models.Trip", b =>
                {
                    b.HasOne("IntercityTransportManagementSystem.Models.TransportLine", "TransportLine")
                        .WithMany("Trips")
